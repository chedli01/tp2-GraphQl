...
export const db = {
  users: [
    { id: 1, name: "aymen", email: "aymen@gmail.com", role: Role.User },
    { id: 2, name: "ahmed", email: "ahmed@gmail.com", role: Role.User },
    { id: 3, name: "sami", email: "samsoum@hotmail.com", role: Role.User },
    { id: 4, name: "admin", email: "admin@gmail.com", role: Role.Admin }
  ],
  cvs: [
